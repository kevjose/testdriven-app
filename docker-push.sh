...
then
  ...
  if [[ "$TRAVIS_BRANCH" == "staging" ]]; then
    export REACT_APP_USERS_SERVICE_URL="http://testdriven-staging-alb-654224272.ap-south-1.elb.amazonaws.com"
  ...
  then
    ...
    # swagger
    docker build $SWAGGER_REPO -t $SWAGGER:$COMMIT -f Dockerfile-dev
